...
class Dispatcher {
	...
	public:
		Dispatcher(uint64_t limit_count, cl_context & clContext, cl_program & clProgram, const Mode mode, const size_t worksizeMax, const size_t inverseSize, const size_t inverseMultiple, const cl_uchar clScoreQuit = 0, const std::string & outputFile = NULL, const std::string & postUrl = NULL);
		~Dispatcher();
